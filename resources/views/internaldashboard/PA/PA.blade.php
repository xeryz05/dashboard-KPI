        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-center">
                    <h4 class="page-title">Revenue Verdanco Indonesia</h4>
                </div>
                        ...
                        <div class="col-xl-8 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <script>
                                 ...
                                 $.get("http://localhost:8000/api/revenues/data",function(dataRev, status){ //ambil data dari DashboardRevenueController
                            ...
                            {{-- <div class="card card-dashboard-eight pb-2">
								...
								<div class="list-group border">
                                    @forelse ($revenues as $item)
										...
										<p>{{ $item->period['month'] }}</p><span>Rp.{{ number_format($item->value_jan) }}</span><br> --}}
										{{-- <p>{{ $item->period['month'] }}</p><span>Rp.{{ number_format($item->value_feb) }}</span> --}}
										{{-- <p>Total :</p><span>Rp.{{ $item->sum('pendapatan_perbulan') }}</span> --}}
                                        {{-- </div> --}}
