...
<body class="main-body app sidebar-mini ltr" >
                    ...
                    <div class="my-auto" >
                        @foreach ($veitemsByDepartment as $departmentId => $veitems)
                            @if ($loop->first)
                                ...
                                <h4 class="page-title">KPI Departement {{ $firstVeitem->period['month'] }} {{ $firstVeitem->period['year'] }}</h4>
                            @endif
                        @endforeach
                        <ol class="breadcrumb">
                                                            ...
                                                            <div class="accordian-body collapse" id="rankDept">
                                                                <table class="table table-striped">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td> <a href="#item{{ $veitemsByDepartment[$departementId]->first()->departement['name'] }}">{{ $veitemsByDepartment[$departmentId]->first()->departement['name'] }}</a></th>
    ...
    <script>
            Highcharts.chart('summary', {
                ...
                series: [{
                    name: 'Speed',
                    data: [{{ number_format($avgsummary,2) }}],
                    tooltip: {
                        valueSuffix: '%'
                    },
                    dataLabels: {
