                    ...
                    <div class="row row-sm">
                                                ...
                                                Highcharts.chart('container', {
                                                    ...
                                                    plotOptions: {
                                                        pie: {
                                                            ...
                                                            dataLabels: {
                                                                enabled: true,
                                                                format: '{point.name}: Rp.{point.y:.2f}'
                                                            },
                                                            showInLegend: true
                                                        }
                                                    },
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <div class="card card-dashboard-eight pb-2">
								<h6 class="card-title">Detail Revenue</h6><span class="d-block mg-b-10 text-muted tx-12">KPI performance revenue Verdanco Engineering</span>
