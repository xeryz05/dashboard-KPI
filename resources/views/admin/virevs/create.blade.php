...
@section('content')
    <div class="main-content app-content">
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<h4 class="page-title">Create Revenue VI</h4>
						<ol class="breadcrumb">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									<p class="mg-b-20"></p>
									<div id="wizard1">
										<h3 class="mb-2">Revenue Information</h3>
										<section>
											<h2 class="d-none">Revenue Information</h2>
											<form action="{{ route('virevs.store') }}" method="post" enctype="multipart/form-data">
												@csrf
