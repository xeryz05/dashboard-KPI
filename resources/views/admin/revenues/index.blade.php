				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="d-flex my-xl-auto right-content align-items-center">
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="/revenue-import" method="post" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="pe-1 mb-xl-0">
                            <a href="" target="_blank" class="btn btn-warning">Export Data</a>
                        </div>
                    </div>
				</div>
				<!-- breadcrumb -->
                                            ...
                                            <tbody>
                                                @foreach ($revenues as $item)
                                                    <tr>
                                                        ...
                                                        <td>Rp. {{ $item->value_mei }}</td>
                                                        <td>Rp. {{ $item->value_juni }}</td>
                                                        <td>
                                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('revenue.destroy', $item->id) }}" method="POST">
                                                                <a href="{{ route('revenue.edit', $item->id) }}" class="btn btn-sm btn-primary"><span class="fe fe-edit"></span></a>
                                                                <a href="{{ route('revenue.show', $item->id) }}" class="btn btn-sm btn-info"><span class="fe fe-more-vertical"></span></a>
