				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Table Permissions</li>
						</ol>
					</div>
                    <div class="d-flex my-xl-auto right-content align-items-center">
						<div class="pe-1 mb-xl-0">
							<a href="{{ route('permission.create') }}" class="btn btn-primary">Create Data</a>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                            ...
                                            <tbody>
                                                @foreach ($permissions as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->name }}</td>
                                                        <td>
                                                            <a href="{{ route('permission.edit', $item->id) }}" class="btn btn-sm btn-primary"><span class="fe fe-edit"></span></a>
