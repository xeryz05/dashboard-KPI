                                            ...
                                            <tbody>
                                                @foreach ($verevenues as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('revenue-ve.destroy', $item->id) }}" method="POST">
                                                                <a href="{{ route('revenue-ve.edit', $item->id) }}" class="btn btn-sm btn-primary"><span class="fe fe-edit"></span></a>
                                                                <a href="{{ route('revenue-ve.show', $item->id) }}" class="btn btn-sm btn-info"><span class="fe fe-more-vertical"></span></a>
