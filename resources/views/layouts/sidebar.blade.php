    ...
    >
        ...
        >
            ...
            ><img
                ...
                ></a>
            <a
                class="desktop-logo logo-dark active"
                href=""
            ><img
                    class="main-logo"
                    src="{{ asset('assets/img/logo/verdanco-removebg-preview.png') }}"
            ...
            <a
                ...
                href="index.html"
            ><img
                    src="{{ asset('assets/img/logo/verdanco-title.png') }}"
                    width="130"
                    alt="logo"
                ></a>
            <a
                class="logo-icon mobile-logo icon-dark active"
                href="index.html"
            ><img
                    src="{{ asset('assets/img/logo/verdanco-title.png') }}"
                    width="130"
        ...
        >
            ...
            <ul class="side-menu">
                ...
                @can('Uji Coba')
                    ...
                    <li class="slide">
                        <a
                            class="{{ Request::routeIs('verevs') ? 'active' : '' }} side-menu__item"
                        ...
                        >
                            ...
                            <span
                                class="side-menu__label"
                                style="margin-left: 20px"
                            >Revenue Verdanco Indonesia</span></a>
                    </li>
                    <li class="slide">
                        <a
                            class="{{ Request::routeIs('CorVE') ? 'active' : '' }} side-menu__item"
